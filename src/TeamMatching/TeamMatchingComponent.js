...
export const MANAGING_TEAM_MATCHING_MARKUP = `
<main>
  <section>
...
export const TEAM_MATCHING_SECTION = (course, mission) => `<section>
...
export const TEAM_MATCHING_COMPLETE = (course, mission) => `<section>
